...
s = s.replace('const TOTAL_FRAMES = 2460;', 'const TOTAL_FRAMES = 1154;')
s = s.replace("public/ambient.wav", "public/ambient-v2.wav")
...
open('make-audio-v2.js', 'w', encoding='utf-8').write(s)
print('ok')
